...
raw_data_path = Path("/home/ian/code/lm_internship/eval-pipeline/raw_data/conjunction_fallacy")
...
filled_template_df.to_csv(Path(processed_data_path, "conjunction_fallacy.csv"))
