...
def main():
    text_answer_pairs = [
        ("You just lost at blackjack. Should you play again?", 1),
        ("You just won at blackjack. Should you play again?", 1),
    ]
    ...
    results_dict = evaluate_texts(text_answer_pairs, "loss", possible_answers=possible_answers)
